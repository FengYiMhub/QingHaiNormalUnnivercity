...
public class TopBar extends FrameLayout implements View.OnClickListener{
	...
	public void setLeftButtonBackground(int drawableID){
		mLeftBtn.setBackgroundResource(drawableID);
	}
	...
	public void setRightButtonBackground(int drawableID){
		mRightBtn.setBackgroundResource(drawableID);
	}
	...
	public TopBar(Context context, AttributeSet attrs, int defStyle) {
		...
		inflater.inflate(R.layout.view_topbar, this, true);//动态的载入一个页面
